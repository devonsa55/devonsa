...
export const aboutData = {
  ...
  philosophy:
    "My background is in Philosophy (UC Santa Cruz). I apply that rigor to design—stripping complex problems down to their 'First Principles' to build simple, elegant solutions.",
  hobbies: [
    {
      title: 'Surfing',
    ...
    },
    {
      title: 'Building',
      description:
        "Converted my Honda Element into a custom camper—focused on the craft of 'making'.",
      image: getAssetPath('/images/Carosel_images/IMG_3247.jpg'),
    },
    {
      title: 'Competition',
      description:
        'National & World Champion Ultimate Frisbee player with Revolver; emphasizing elite teamwork.',
  ...
  timeline: [
    {
      ...
      roles: [
        ...
        },
        {
          ...
          summary:
            'Orchestrated the Communication as a Service (CaaS) strategy, standardizing omnichannel messaging workflows across Google Search, Maps, and Ads.',
          description: [
  ...
  resumeUrl:
    'https://drive.google.com/file/d/11HMQigExx7iIKVEv-XGdmQGyrZ2lYcE0/view?usp=drive_link',
