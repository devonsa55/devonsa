...
export const aiProjects: AIProjectCaseStudy[] = [
  {
    ...
    subtitle: "A comprehensive source of truth for generating VibeCoding UIs, extracting core aesthetics, and component rules.",
    tags: ["Design Systems", "Documentation"],
    role: "System Architecture",
    timeline: "Living Document",
    problem: "When initiating a new session to build features, AI coding assistants often lack the global context needed to maintain perfect aesthetic and structural consistency across the repository.",
  ...
  {
    id: "declarative-ui-playground",
    title: "Declarative UI Playground",
    subtitle: "A live-rendering engine translating raw JSON payloads directly into complex interactive Recharts and Shadcn component trees.",
    tags: ["React", "Architecture", "Data Vis"],
    role: "Front-End Architect",
    timeline: "Experiment",
    problem: "Proving that UI can be completely decoupled from its underlying data structure, allowing non-developers or AI agents to construct functional interfaces simply by passing valid JSON.",
    solution: "A custom recursive React component renderer that uses a registry pattern to map string names to Recharts and Shadcn components dynamically.",
    heroIcon: "TrendingUp",
    cardImageBg: "var(--bg-secondary)",
    instructions: []
  }
