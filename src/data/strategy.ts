...
export const strategyFrameworks: StrategyItem[] = [
  {
    ...
    subtitle: '',
    description:
      'Translating high-level agentic mandates into defensible, traceable product roadmaps.',
    ...
    layout: 'paper',
    deckEmbed:
      'https://docs.google.com/presentation/d/e/2PACX-1vRvkv-tHQYZHpDLY5J3uKWzqbil6UggQeRqpMiC0amVWXMdyahSBUH-FCKD09FpODS0qCxThFb4N6Lt/pubembed?start=false&loop=false&delayms=3000',
    problem:
      'How do we build trust when AI models are inherently probabilistic and prone to hallucinations?',
    ...
    sections: [
      {
        ...
        content:
          'The core tension in LLMs is that a helpful answer is not always an accurate one. This framework helps designers navigate that edge.',
        layout: 'text-only',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Aligning incentives across Maps, Search, and Ads to build cohesive platform experiences.',
