...
const AnimatedConversationalInsights = ({ className = '' }: { className?: string }) => {
    ...
    return (
        ...
        >
            ...
            {/* Base Line */}
            <motion.path variants={drawLine} d="M10 360H330" stroke="#111111" strokeWidth="4" strokeLinecap="round" />

            {/* Bars popping up */}
            <motion.path custom={1} variants={popIn} d="M30 360V264C30 257.635 32.5286 251.53 37.0294 247.029C41.5303 242.529 47.6348 240 54 240C60.3652 240 66.4697 242.529 70.9706 247.029C75.4714 251.53 78 257.635 78 264V360H30Z" fill="#E8E8ED" stroke="#111111" strokeWidth="4" strokeLinejoin="round" />
            <motion.path custom={2} variants={popIn} d="M100 360V204C100 197.635 102.529 191.53 107.029 187.029C111.53 182.529 117.635 180 124 180C130.365 180 136.47 182.529 140.971 187.029C145.471 191.53 148 197.635 148 204V360H100Z" fill="#E8E8ED" stroke="#111111" strokeWidth="4" strokeLinejoin="round" />
            ...
            <motion.g
                ...
                viewport={{ once: true }}
            >
                <path d="M229 65H361C367.365 65 373.47 67.5286 377.971 72.0294C382.471 76.5303 385 82.6348 385 89V181C385 187.365 382.471 193.47 377.971 197.971C373.47 202.471 367.365 205 361 205H275L195 255L235 205H229C222.635 205 216.53 202.471 212.029 197.971C207.529 193.47 205 187.365 205 181V89C205 82.6348 207.529 76.5303 212.029 72.0294C216.53 67.5286 222.635 65 229 65Z" fill="#F5F5F7" stroke="#111111" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M290 100C290 122 308 140 330 140C308 140 290 158 290 180C290 158 272 140 250 140C272 140 290 122 290 100Z" fill="url(#paint0_linear_1059_2929)" stroke="#111111" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            </motion.g>
