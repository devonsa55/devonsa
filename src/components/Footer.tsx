    ...
    <footer className="pt-20 pb-16 border-t border-border-subtle bg-bg-primary relative z-10">
      <div className="container flex flex-col min-[968px]:flex-row justify-between items-start gap-[3rem] min-[968px]:gap-10 max-w-[800px] mx-auto pb-0">
        <div className="footer-brand">
          <Link
            to="/"
            className="block transition-transform duration-300 ease hover:scale-105 hover:-rotate-2"
          >
            <img
        ...
        <div className="flex flex-col min-[480px]:flex-row min-[968px]:justify-end justify-between flex-1 gap-8 min-[480px]:gap-4 min-[968px]:gap-16 w-full max-w-full">
          <div className="min-w-[120px]">
            <h4 className="mb-6 text-xs uppercase tracking-[0.15em] text-text-primary font-extrabold opacity-50">
              Navigation
            </h4>
            <Link
              to="/#work"
              className="block mb-3 text-text-secondary text-base transition-all duration-300 whitespace-nowrap font-medium hover:text-text-primary hover:translate-x-1"
            >
              Work
            </Link>
            <Link
      ...
      <div className="container flex flex-col min-[480px]:flex-row justify-between min-[480px]:items-center pt-10 max-w-[800px] mx-auto text-text-secondary text-[0.9rem] border-t border-border-subtle gap-6 min-[480px]:gap-0 text-center min-[480px]:text-left">
        ...
        <div
          className="cursor-pointer flex items-center justify-center min-[480px]:justify-start gap-2 font-bold text-text-primary transition-all duration-300 hover:text-text-primary hover:-translate-y-[2px]"
      ...
      <div className="container max-w-[800px] mx-auto text-center min-[480px]:text-left">
        <p className="mt-4 text-[0.8rem] text-text-secondary opacity-50">
          This portfolio was built in code with Claude, Supabase, Vercel, and GitHub.
        </p>
      </div>
    </footer>
  )
