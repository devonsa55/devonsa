      ...
      <motion.div {...fadeIn} className="project-detail project-visual-root">
        ...
        <div className="container" style={{ paddingTop: '80px' }}>
          <article className="strategy-paper">
              ...
              >
                ...
                {strategy.heroImageAttribution && (
                  ...
                  >
                    ...
                    >
                      @{strategy.heroImageAttribution.name}
                    </a>
                  </div>
                )}
              </motion.div>
            ...
            {strategy.deckEmbed && (
              <motion.div {...fadeIn} className="deck-container-expanded">
                <iframe
            ...
            {strategy.id === 'managing-complexity' && (
              <div className="insight-block">
                <p>
                  “The probability of success goes down exponentially with the number of
                  collaborators.”
                </p>
              </div>
            )}
            ...
            {strategy.sections?.[2] && (
              <>
                ...
                <div className="paper-section">{renderText(strategy.sections[2].content)}</div>
              </>
            )}
    ...
    <motion.div {...fadeIn} className="project-detail project-visual-root">
      ...
      <div className="container">
        <header className="project-header">
          ...
          <motion.p className="subtitle" {...fadeInUp} transition={{ delay: 0.2 }}>
            {strategy.subtitle}
          </motion.p>
        </header>
        ...
        <div
          className="project-footer"
          style={{ paddingBottom: '8rem', display: 'flex', justifyContent: 'center' }}
        >
          <ProfileCard
            icon={<Home size={20} />}
            text="Back to Home"
