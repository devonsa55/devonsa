  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h4 style={{ margin: 0, fontSize: '1.25rem', fontWeight: '800', lineHeight: 1.15 }}>
        ...
        >
          ...
          <div>
            <h4 style={{ margin: 0, fontSize: '1.1rem', fontWeight: '800', lineHeight: 1.15 }}>
              Powerful Clarity
            </h4>
            <span
              style={{
