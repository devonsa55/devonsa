        ...
        {isIdle && (
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M34.7549 57.6988C37.8919 53.0548 47.6939 49.2228 54.8129 57.6988"
                stroke="#1C1C26"
                strokeWidth="3"
                strokeMiterlimit="10"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M72.038 38.6659C68.806 38.6659 66.187 44.5069 66.187 51.7119C66.187 58.9169 68.807 64.7579 72.038 64.7579C75.27 64.7579 77.889 58.9169 77.889 51.7119C77.89 44.5069 75.27 38.6659 72.038 38.6659Z"
                fill="#1C1C26"
              />
              <path
                d="M22.855 66.6569C23.693 70.6539 25.213 74.5799 27.455 78.2689C38.062 95.7269 60.813 101.28 78.27 90.6729C86.999 85.3689 92.752 77.0299 94.996 67.8339"
                stroke="#1C1C26"
                strokeWidth="3"
                strokeMiterlimit="10"
              />
